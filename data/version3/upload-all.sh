...
# Names
echo 'names-0.nt'
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://biodiversity.org.au/afd/publication -H 'Content-Type: text/rdf+n3' --data-binary '@names-0.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
echo 'names-500000.nt'
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://biodiversity.org.au/afd/publication -H 'Content-Type: text/rdf+n3' --data-binary '@names-500000.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
echo 'names-1000000.nt'
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://biodiversity.org.au/afd/publication -H 'Content-Type: text/rdf+n3' --data-binary '@names-1000000.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
echo 'names-1500000.nt'
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://biodiversity.org.au/afd/publication -H 'Content-Type: text/rdf+n3' --data-binary '@names-1500000.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
echo 'names-2000000.nt'
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://biodiversity.org.au/afd/publication -H 'Content-Type: text/rdf+n3' --data-binary '@names-2000000.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
echo 'names-2500000.nt'
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://biodiversity.org.au/afd/publication -H 'Content-Type: text/rdf+n3' --data-binary '@names-2500000.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
echo 'names-3000000.nt'
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://biodiversity.org.au/afd/publication -H 'Content-Type: text/rdf+n3' --data-binary '@names-3000000.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
echo 'names-3500000.nt'
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://biodiversity.org.au/afd/publication -H 'Content-Type: text/rdf+n3' --data-binary '@names-3500000.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
echo 'names-4000000.nt'
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://biodiversity.org.au/afd/publication -H 'Content-Type: text/rdf+n3' --data-binary '@names-4000000.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
...
# Wikispecies
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://species.wikimedia.org -H 'Content-Type: text/rdf+n3' --data-binary '@wikispecies.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
...
curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://zenodo.org -H 'Content-Type: text/rdf+n3' --data-binary '@assassins.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5

curl http://kg-blazegraph.sloppy.zone/blazegraph/sparql?context-uri=https://zenodo.org -H 'Content-Type: text/rdf+n3' --data-binary '@weevils.nt'  --progress-bar | tee /dev/null
echo ''
sleep 5
